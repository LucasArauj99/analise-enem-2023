...
📁 dados/ │ ├── dados_enem_2023.zip # Arquivo compactado com o CSV tratado │ └── MICRODADOS_ENEM_2023.csv # Arquivo original (ignorado pelo Git). 
📁 utils/ │ ├── grafico.py # Funções utilitárias para visualização │ └── utilitarios.py # Outras funções úteis para reaproveitamento.
